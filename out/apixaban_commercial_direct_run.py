...
from src.render_exec_questions_report import render_exec_questions_report
from src.render_full_dossier_pdf import render_full_dossier_pdf
from src.dossier_report_generator import DossierReportGenerator


TENANT_ID = "demo"
CASE_ID = "aa736d2c-9ab2-42a7-8c34-62d4aff314d9"
INN = "apixaban"
OUT_DIR = Path("/app/out/apixaban_commercial_direct_run")
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        dossier = generator.generate(
            case_id=CASE_ID,
            run_id=f"commercial_direct_{int(time.time())}",
            deadline=None,
    ...
    render_full_dossier_pdf(dossier_json, str(OUT_DIR / "full_dossier.pdf"))
    render_exec_questions_report(exec_results, str(OUT_DIR / "exec_questions_report.pdf"), inn=INN)
